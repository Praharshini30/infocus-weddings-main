...
export default function CorporateSection({ visible }) {
  ...
  return (
    <section className="pf-section pf-corporate" id="portfolio-corporate-events" style={{ scrollMarginTop: '110px' }}>
      <div className="pf-section-head" style={{ maxWidth: '850px', margin: '0 auto', textAlign: 'center' }}>
        <Reveal>
          ...
          >
            <p className="pf-section-text" style={{ margin: '0 auto', fontSize: '1rem', lineHeight: '1.85', color: 'var(--pf-muted)' }}>
